...
public class ConnectNFrame_HelpMessage extends JPanel {
	...
	public ConnectNFrame_HelpMessage() {
        ...
        JLabel lblHelpTitle = new JLabel("Welcome to Connect N Game");
        ...
        JLabel lbl1_1 = new JLabel("     -Rows: Must be at least 4, or at most 12.");
        ...
        JLabel lbl1_2 = new JLabel("     -Columns: Must be at least 4, or at most 12.");
        ...
        JLabel lbl1_3 = new JLabel("     -Number of tokens to connect: Must be at least 3, and at most 8 or the largest of rows or columns.");
        ...
        JLabel lbl1_4 = new JLabel("     -Your names: At least 1 character long.");
        ...
        JLabel lbl2 = new JLabel("2. Once you are in a game, you will be able to:");
        ...
        JLabel lbl2_1 = new JLabel("     -Select a column with the buttons at the top, then click 'Drop Token' to play.");
        ...
        JLabel lbl2_2 = new JLabel("     -Undo the previous turn when the button is available.");
        ...
        JLabel lbl2_2_1 = new JLabel("          -It undoes the previous turn and resets to the previous player.");
        ...
        JLabel lbl2_3 = new JLabel("     -Save the current state of the board, load an old saved game, create a new game, or quit.");
        ...
        JLabel lblHaveFun = new JLabel("Have fun playing Connect N!!");
